...
def fill_schedule(scenario, balancing_groups, sim_duration):
    ...
    gen_schedule = scenario + 'Generation_schedule.csv' #'01_hist_data//vali_' + 'Generation_schedule.csv'
    ...
    load_schedule = scenario + 'Consumption_schedule.csv' #'01_hist_data//vali_' + 'Consumption_schedule.csv'
...
def fill_power_load(scenario, balancing_groups, sim_duration):
    ...
    kw_gen_file = scenario + 'Generation.csv' # '01_hist_data//vali_' + 'Generation.csv'
    ...
    kw_load_file = scenario + 'Consumption.csv' # '01_hist_data//vali_' + 'Consumption.csv'
...
def get_balancing_groups(scenario, sb_ON, sim_duration):
    ...
    bg_file = scenario + 'Balancing_groups.csv' # '01_hist_data//vali_' + 'Balancing_groups.csv'
